...
exports.main = function(options, callbacks) {
  ...
  PageMod({
    contentScriptFile: [
      data.url("js/vendor/jquery-2.0.3.js"),
      data.url("js/vendor/angular.js"),
      data.url("js/vendor/angular-resource.js"),
      data.url("js/vendor/angular-sanitize.js"),
      data.url("js/vendor/moment.js"),
      //data.url("js/vendor/d3.v3.js"),
      //data.url("js/vendor/xcharts.js"),
      data.url("js/app.js"),
      //"chrome://global/content/interestsTextClassifier.js",
    ],
